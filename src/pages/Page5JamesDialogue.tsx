...
const ASSETS = {
  background: '/assets/background-dialogue-james.png',
  character: '/assets/character-james.png',
  replay: '/assets/button-replay.png',
  microphone: '/assets/button-microphone.png',
} as const

type Page5JamesDialogueProps = {
  onClose: () => void
  onNext?: () => void
...
export function Page5JamesDialogue({
  onClose,
  onNext,
  transitionComplete,
  active,
}: Page5JamesDialogueProps) {
