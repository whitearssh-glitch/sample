...
const ASSETS = {
  missionFrame: `${V3}/mission-frame.png`,
  missionTitle: `${V3}/mission-title.png`,
  expressions: [
    `${V3}/mission-expression-01.png`,
    `${V3}/mission-expression-02.png`,
    `${V3}/mission-expression-03.png`,
    `${V3}/mission-expression-04.png`,
  ],
...
type Page1IntroV3Props = {
  onStart: () => void
  onClose: () => void
  isTransitioning?: boolean
}

export function Page1IntroV3({ onStart, onClose, isTransitioning }: Page1IntroV3Props) {
