...
const ASSETS = {
  background: `${V3}/background-dialogue-leo.png`,
  characterVideoWebm: `${V3}/character-leo.webm`,
  replay: `${V3}/button-replay.png`,
  microphone: `${V3}/button-microphone.png`,
} as const

type Page5JamesDialogueV3Props = {
  onClose: () => void
  onNext?: () => void
...
export function Page5JamesDialogueV3({
  onClose,
  onNext,
  transitionComplete,
  active,
}: Page5JamesDialogueV3Props) {
