...
const ASSETS = {
  background: `${V3}/background-dialogue-emma.png`,
  characterVideoWebm: `${V3}/character-emma.webm`,
  characterVideoMp4: `${V3}/character-emma.mp4`,
  replay: `${V3}/button-replay.png`,
  hintBulb: '/assets/hint-bulb.png',
  hint01: '/assets/hint-01.png',
  hint02: '/assets/hint-02.png',
  microphone: `${V3}/button-microphone.png`,
} as const

type Page2DialogueV3Props = {
  onClose: () => void
  onNext?: () => void
...
export function Page2DialogueV3({
  onClose,
  onNext,
  transitionComplete,
  active,
}: Page2DialogueV3Props) {
  const consumedSnapshotRef = useRef(consumeDialogueExitSnapshot('ver3'))
  ...
  useEffect(() => {
    ...
    if (hookActive && !popupOpen) {
      void video.play().catch(() => {})
      return
    }

    video.pause()
  }, [hookActive, popupOpen])
  ...
  const handleScoreWipeNext = () => {
    ...
    captureDialogueExitSnapshot(snapshot, 'ver3')
        ...
        <div className="page-dialogue__content">
          <div className="page-dialogue__character-wrap">
            ...
            <video
              ...
              className="page-dialogue__character page-dialogue__character-video"
              autoPlay
              muted
              playsInline
              loop
              ...
              aria-label="Emma"
            >
              <source src={ASSETS.characterVideoWebm} type="video/webm" />
              <source src={ASSETS.characterVideoMp4} type="video/mp4" />
            </video>
          </div>
